...
function Box() {
  return (
    <div className="rounded-xl sm:p-5 mt-1 p-5 border-2 border-zinc-900 bg-[#070707] font-semibold flex flex-col justify-between items-center sm:w-full w-full  text-xl sm:text-2xl h-screen">
      <div className="bg-black p-5 sm:mt-0 rounded-xl item-center justify-center w-full border-2 border-zinc-900 h-screen">
